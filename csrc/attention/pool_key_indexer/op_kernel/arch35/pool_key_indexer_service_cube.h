...
/*!
 * \file pool_key_indexer_service_cube.h
 * \brief use 5 buffer for matmul l1, better pipeline
 */
#ifndef POOL_KEY_INDEXER_SERVICE_CUBE_H
#define POOL_KEY_INDEXER_SERVICE_CUBE_H
...
PoolKeyIndexerServiceCube<LIT>::InitMm1GlobalTensor(const GlobalTensor<int32_t> &blkTableGm,
...
__aicore__ inline void PoolKeyIndexerServiceCube<LIT>::ComputeMm1(const PkiCommon::RunInfo &runInfo)
{
    CrossCoreWaitFlag<PkiCommon::ConstInfo::PKI_SYNC_MODE4, PIPE_FIX>(
                                                    PkiCommon::ConstInfo::CROSS_VC_EVENT + runInfo.loop % 2);
    CrossCoreWaitFlag<PkiCommon::ConstInfo::PKI_SYNC_MODE4, PIPE_FIX>(
                                                    PkiCommon::ConstInfo::CROSS_VC_EVENT +
                                                    runInfo.loop % 2 +
                                                    PkiCommon::ConstInfo::AIV0_AIV1_OFFSET);
    ...
    CrossCoreSetFlag<PkiCommon::ConstInfo::PKI_SYNC_MODE4, PIPE_FIX>(
                                                PkiCommon::ConstInfo::CROSS_CV_EVENT +
                                                runInfo.loop % 2);
    CrossCoreSetFlag<PkiCommon::ConstInfo::PKI_SYNC_MODE4, PIPE_FIX>(
                                                PkiCommon::ConstInfo::CROSS_CV_EVENT +
                                                runInfo.loop % 2 +
...
template <typename LIT>
__aicore__ inline void PoolKeyIndexerServiceCube<LIT>::LoadQueryToL0a(uint64_t s1gGmOffset,
...
template <typename LIT>
__aicore__ inline void PoolKeyIndexerServiceCube<LIT>::LoadKeyToL0b(uint64_t s2L1Offset,
...
template <typename LIT>
__aicore__ inline void PoolKeyIndexerServiceCube<LIT>::Fixp(uint64_t s1gGmOffset,
