...
ASCENDC_TPL_ARGS_DECL(PoolKeyIndexer,
                      ASCENDC_TPL_DTYPE_DECL(DT_Q, PKI_TPL_FP16, PKI_TPL_BF16, PKI_TPL_FP8),
                      ASCENDC_TPL_DTYPE_DECL(DT_K, PKI_TPL_FP16, PKI_TPL_BF16, PKI_TPL_FP8),
                      ASCENDC_TPL_DTYPE_DECL(DT_OUT, PKI_TPL_INT32),
                      ASCENDC_TPL_UINT_DECL(LAYOUT_Q, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
                                            PKI_LAYOUT_BSND, PKI_LAYOUT_TND),
                      ASCENDC_TPL_UINT_DECL(LAYOUT_K, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
                                            PKI_LAYOUT_BSND, PKI_LAYOUT_TND, PKI_LAYOUT_PA_BBND),
                      ASCENDC_TPL_UINT_DECL(MASK_MODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
                                            PKI_TPL_MASK_DEFAULT, PKI_TPL_MASK_CAUSAL),
                      ASCENDC_TPL_UINT_DECL(QUANT_MODE, ASCENDC_TPL_4_BW, ASCENDC_TPL_UI_LIST,
                                            PKI_TPL_QUANT_NONE, PKI_TPL_QUANT_FP8_PER_TOKEN, PKI_TPL_QUANT_MXFP8),
...
ASCENDC_TPL_SEL(
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_DTYPE_SEL(DT_Q, PKI_TPL_FP16),
        ASCENDC_TPL_DTYPE_SEL(DT_K, PKI_TPL_FP16),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_DTYPE_SEL(DT_Q, PKI_TPL_BF16),
        ASCENDC_TPL_DTYPE_SEL(DT_K, PKI_TPL_BF16),
        ASCENDC_TPL_DTYPE_SEL(DT_OUT, PKI_TPL_INT32),
        ASCENDC_TPL_UINT_SEL(LAYOUT_Q, ASCENDC_TPL_UI_LIST, PKI_LAYOUT_BSND),
        ASCENDC_TPL_UINT_SEL(LAYOUT_K, ASCENDC_TPL_UI_LIST, PKI_LAYOUT_BSND),
        ASCENDC_TPL_UINT_SEL(MASK_MODE, ASCENDC_TPL_UI_LIST, PKI_TPL_MASK_DEFAULT),
    ...
    ASCENDC_TPL_ARGS_SEL(
        ASCENDC_TPL_DTYPE_SEL(DT_Q, PKI_TPL_FP8),
        ASCENDC_TPL_DTYPE_SEL(DT_K, PKI_TPL_FP8),
        ASCENDC_TPL_DTYPE_SEL(DT_OUT, PKI_TPL_INT32),
