...
template <typename COMP>
__aicore__ inline void KeyPoolKernelFullLoad<COMP>::SkipInvalidBatch(BatchInfo &batchInfo)
{
...
template <typename COMP>
__aicore__ inline bool KeyPoolKernelFullLoad<COMP>::IsNeedExcuteC1(RunInfo info)
{
    // B超出范围则cube不执行
